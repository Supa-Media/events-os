...
export const DEVELOPMENT_SECTIONS: Omit<AcademySection, "order">[] = [
  ...
  // ── 87 · Donor stewardship: the relationship workflow ───────────────────
  {
    ...
    quiz: [
      ...
      {
        prompt:
          "You hand-pick someone into a campaign's segment, but they've unsubscribed from every campaign. What happens?",
        options: [

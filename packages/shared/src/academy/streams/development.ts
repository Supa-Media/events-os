    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "**Who can do this.** Filling in an agreement — its terms, events, credits, documents — and sending the link is the partnership team's own power (`giving.partners.edit`), held by Partnership and Fundraising Associates as well as the Development Director. It is narrower than running the donor CRM on purpose: the same associate never records a gift, edits a donor, or imports — that stays the director's `giving.edit`. Recording a partner's payment against the agreement is a director action.",

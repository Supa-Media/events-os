    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "**No account? No problem:** a finance manager can send you a link that opens a page showing what's owed and takes you straight to checkout — no login, nothing to install. It's the same page whether you're on the team or left two years ago, and it works for a manager paying on somebody's behalf too. The page deliberately doesn't name anyone: it shows the amounts and dates and asks for them back, so a link that gets forwarded doesn't tell a stranger whose charges they are.",

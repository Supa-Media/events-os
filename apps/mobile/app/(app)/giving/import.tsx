...
function ImportBody({ scope }: { scope: GivingScope }) {
  ...
  // rows instead of the plain `parseCanonicalRows` path. (A Givebutter
  // CONTACTS export has its own home now — People → Import; this screen
  // stays the money-bearing path.)

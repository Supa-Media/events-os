...
// GONE. `isPdfReceipt` (filename-only) and `isDocumentReceipt` (text/* only)
// were two of the FIVE mutually-inconsistent answers to "what kind of file is
// this receipt". There is now exactly one: `receiptFileKind` in
// `@events-os/shared` — read its module doc for the inventory of what each of
// the five got wrong. Import it directly; do not re-wrap it here.

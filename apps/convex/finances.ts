...
import { ROLLUP_SCAN_LIMIT, MONTH_NAMES } from "./lib/financeInternals/constants";
import {
...
import {
  ...
  effectiveType, effectiveRefKind, txnCountsTowardBudget, type BudgetLevel,
...
import {
  type DashPeriod, inDashRange, txnCountsTowardTagAgg, txnCountsTowardBudgetDash,
  recurringAppliesToDash, monthEquivForDash,
...
import {
  requireTagInLevel, linkBudgetTag, autoTagEventBudget, loadBudgetTags,
} from "./lib/financeInternals/budgetTags";
import { eventBudgetLabel } from "./lib/financeInternals/budgetRefLifecycle";
import {
  assertBudgetTransition, logBudgetDecision, loadBudgetForApprovalDecision,
} from "./lib/financeInternals/budgetApproval";
import {
  seedDefaultCategoriesForChapter, categoryAncestorHits,
} from "./lib/financeInternals/categoriesAndFunds";
import {
  ensureBudgetForRef, verifyBudgetRefs, setBudgetAmount, cascadeDeleteBudget,
...
import {
  ...
  computeReassignmentPatch, buildReassignSummary, transferRefScope,
} from "./lib/financeInternals/reassignment";
import { runBudgetScopeMigration } from "./lib/financeInternals/migrations/budgetScope";
import {
  runBackfillEventBudgets, runBackfillProjectBudgets,
} from "./lib/financeInternals/migrations/eventProjectBackfill";
import { runRemoveEmptyAutoBudgets } from "./lib/financeInternals/migrations/emptyBudgetsCleanup";
import { runMigrateLinksToBudgets } from "./lib/financeInternals/migrations/linksToBudgets";
import {
  runReconcileEntityBudgetDrift, runHealRowlessEntityBudgets,
} from "./lib/financeInternals/migrations/entityBudgetDrift";
...
export {
  isSpend, txnMatchesMode, inPeriod, isSuggestible, assertIntegerCents,
} from "./lib/financeInternals/txnGuards";
export {
  effectiveCapCents, isAttributableBudget, effectiveType, effectiveRefKind,
} from "./lib/financeInternals/budgetCore";
export {
  eventBudgetLabel, createEventBudget, hasBudgetForRef, getBudgetForRef,
  syncBudgetIdentityForRef, createProjectBudget,

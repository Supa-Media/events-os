...
export const LTN_COMMS: ItemRow[] = [
  ...
  { title: "Spiritual reminder to the team", offsetDays: -3, role: "comms_lead", fields: { channel: ["imessage_group", "google_chat"], audience: ["leaders", "volunteers"] } },
  { title: "Announce full lineup to RSVP'd guests", offsetDays: -3, role: "comms_lead", fields: { channel: ["partiful_posh"], audience: ["attendees"] } },
  { title: "Volunteer penultimate reminder", offsetDays: -1, role: "comms_lead", fields: { channel: ["imessage_group", "google_chat"], audience: ["volunteers"], notes: "Cover call time + what's expected." } },

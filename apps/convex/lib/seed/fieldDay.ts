...
export const FIELD_DAY_COMMS: ItemRow[] = [
  ...
  { title: "Discuss comms schedule with social media team", offsetDays: daysToEvent("2026-07-02"), fields: { channel: ["google_chat"] } },
  { title: "Schedule run of show meeting with directors", offsetDays: daysToEvent("2026-07-02"), fields: { channel: ["google_chat"], audience: ["leaders"] } },
  { title: "Set up auto-send for Posh notifications", offsetDays: daysToEvent("2026-07-08"), fields: { channel: ["partiful_posh"] } },
  { title: "Call for volunteers on socials", offsetDays: -21, fields: { channel: ["ig_stories", "imessage_group", "google_chat"], audience: ["volunteers", "leaders"], notes: "Create a group chat for volunteers and message to schedule a volunteers meeting." } },
  ...
  { title: "Reminder to be on time — directors/core team", offsetDays: -2, fields: { channel: ["google_chat"], audience: ["leaders"] } },
  ...
  { title: "Core team penultimate reminder", offsetDays: -1, fields: { channel: ["google_chat"], audience: ["leaders"] } },
  ...
  { title: "Core team good morning chat", offsetDays: 0, fields: { channel: ["google_chat"], audience: ["leaders"] } },

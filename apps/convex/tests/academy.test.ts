...
describe("curriculum content", () => {
  test("one hundred sixteen ordered sections; six capstones; one optional bonus", () => {
    ...
    // capstone) + 5 (the /collaborate fold-in:
    ...
    // + 1 (finance-receipt-exceptions, inserted into the finances-for-everyone
    // course after finance-card-and-receipts — required, not a capstone. Its
    // own lesson rather than a rule bolted onto the card lesson: receipt
